...
class Backbone(nn.Module):
    def __init__(self, n_classes=2, encoder_relu=False, decoder_relu=True):
        ...
        self.initial_block = InitialBlock(6, 16, relu=encoder_relu)
...
if __name__ == "__main__":
    ...
    # summary(model, input_size=(config.batch_size, 3, config.image_size, config.image_size))
    # print(model)