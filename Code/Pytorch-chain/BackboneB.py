...
class Backbone(nn.Module):
    def __init__(self) -> None:
        ...
        self.encoder_1_2 = nn.Sequential(
            nn.Conv2d(in_channels=self.dim_0, out_channels=self.dim_1, kernel_size=1, stride=1, padding=0),
            nn.ReLU(),
        ...
        ### layer-2
        self.encoder_2_0_2 = nn.Sequential(
            nn.Conv2d(in_channels=self.dim_1, out_channels=self.dim_2, kernel_size=1, stride=1, padding=0),
            nn.ReLU(),
        ...
        self.encoder_2_1_2 = nn.Sequential(
            nn.Conv2d(in_channels=self.dim_1, out_channels=self.dim_2, kernel_size=1, stride=1, padding=0),
            nn.ReLU(),
            nn.BatchNorm2d(num_features=self.dim_2),
            nn.Conv2d(in_channels=self.dim_2, out_channels=self.dim_2, kernel_size=1, stride=1, padding=0),
        ...
        self.encoder_2_2_2 = nn.Sequential(
            nn.Conv2d(in_channels=self.dim_1, out_channels=self.dim_2, kernel_size=1, stride=1, padding=0),
            nn.ReLU(),
            nn.BatchNorm2d(num_features=self.dim_2),
            nn.Conv2d(in_channels=self.dim_2, out_channels=self.dim_2, kernel_size=1, stride=1, padding=0),
        ...
        '''
        # layer-~2
        self.decoder_2_0_2 = nn.Sequential(
        ...
        self.decoder_2_1_2 = nn.Sequential(
            nn.Conv2d(in_channels=self.dim_2, out_channels=self.dim_1, kernel_size=1, stride=1, padding=0),
            nn.ReLU(),
            nn.BatchNorm2d(num_features=self.dim_1),
            nn.Conv2d(in_channels=self.dim_1, out_channels=self.dim_1, kernel_size=1, stride=1, padding=0),
        ...
        self.decoder_2_2_2 = nn.Sequential(
            nn.Conv2d(in_channels=self.dim_2, out_channels=self.dim_1, kernel_size=1, stride=1, padding=0),
            nn.ReLU(),
            nn.BatchNorm2d(num_features=self.dim_1),
            nn.Conv2d(in_channels=self.dim_1, out_channels=self.dim_1, kernel_size=1, stride=1, padding=0),
        ...
        # layer-~1
        self.decoder_1_0_2 = nn.Sequential(
        ...
        self.decoder_1_1_2 = nn.Sequential(
            nn.Conv2d(in_channels=self.dim_1, out_channels=self.dim_0, kernel_size=1, stride=1, padding=0),
            nn.ReLU(),
            nn.BatchNorm2d(num_features=self.dim_0),
            nn.Conv2d(in_channels=self.dim_0, out_channels=self.dim_0, kernel_size=1, stride=1, padding=0),
        ...
        self.decoder_1_2_2 = nn.Sequential(
            nn.Conv2d(in_channels=self.dim_1, out_channels=self.dim_0, kernel_size=1, stride=1, padding=0),
            nn.ReLU(),
            nn.BatchNorm2d(num_features=self.dim_0),
            nn.Conv2d(in_channels=self.dim_0, out_channels=self.dim_0, kernel_size=1, stride=1, padding=0),
        ...
        # layer-~0
        self.decoder_0_0_2 = nn.Sequential(
        ...
        self.decoder_0_1_2 = nn.Sequential(
            nn.Conv2d(in_channels=self.dim_0, out_channels=2, kernel_size=1, stride=1, padding=0),
            nn.ReLU(),
            nn.BatchNorm2d(num_features=2),
            nn.Conv2d(in_channels=2, out_channels=2, kernel_size=1, stride=1, padding=0),
        ...
        self.decoder_0_2_2 = nn.Sequential(
            nn.Conv2d(in_channels=self.dim_0, out_channels=2, kernel_size=1, stride=1, padding=0),
            nn.ReLU(),
            nn.BatchNorm2d(num_features=2),
            nn.Conv2d(in_channels=2, out_channels=2, kernel_size=1, stride=1, padding=0),
